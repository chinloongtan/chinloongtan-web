...
;// CONCATENATED MODULE: ./node_modules/@mui/material/esm/styles/cssUtils.js
...
;// CONCATENATED MODULE: ./node_modules/@mui/material/esm/styles/responsiveFontSizes.js
...
/* unused reexport */ __webpack_require__(37645)
...
var Typist = function (_a) {
    ...
    var _r = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''), text = _r[0], setText = _r[1];
    var _s = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), isDeleting = _s[0], setIsDeleting = _s[1];
    var _t = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0), loopNum = _t[0], setLoopNum = _t[1];
    var _u = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(typingSpeed), writingSpeed = _u[0], setWritingSpeed = _u[1];
    var refText = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(text);
    var refIsDeleting = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(isDeleting);
    var refLoopNum = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(loopNum);
    var refWritingSpeed = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(writingSpeed);
    var refTimer = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(0);
    var refIsGoingToDelete = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
    var refIsFinished = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
    refText.current = text;
    refIsDeleting.current = isDeleting;
    refLoopNum.current = loopNum;
    refWritingSpeed.current = writingSpeed;
    var handleType = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        ...
        return function () { return clearTimeout(refTimer.current); };
    }, [handleType, startDelay]);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: style },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: className }, text),
        !(refIsFinished.current && hideCursorOnFinish) && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "typist-cursor " + (cursorClassName + " " + className), style: {
                opacity: 0,
...
/* harmony default export */ __webpack_exports__["Z"] = (Typist);
